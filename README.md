# Practical task repository for Module 6 - Interface Segregation Principle

```
This repository has violations of Interface Segregation Principle, discussed in the course.
